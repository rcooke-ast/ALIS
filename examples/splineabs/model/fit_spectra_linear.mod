...
model read
  ...
  lim splineabs TotalColDens [-22,22]
  emission
    legendre 1.0   0.01   0.01    scale=[1.0,1.0,1.0]   specid=0
  absorption
  splineabs   ion=16O_I        4.0      0.0ZABS  4.048338      0.0000000FIXL       0.0818007      0.2323805      1.0000000      1.0000000FIXC      0.8562307      0.4530773      0.0220766      0.0000000FIXR   specid=0    blind=False      locations=-12.0,-9.0,-6.0,-3.0,0.0,3.0,6.0,9.0,12.0   ColDensScale=1.0E13 logN=False
