...
def parser(options=None):
    ...
    parser.add_argument("-q", "--quiet", default=False, action="store_true", help="Quiet mode: only warnings and errors (verbosity 0)")
    ...
    parser.add_argument("-o", "--outname", type=str, default=False, help="Model output name")
