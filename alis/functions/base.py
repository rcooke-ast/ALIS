...
from alis.functions import brokenpowerlaw
from alis.functions import chebyshev
from alis.functions import constant
from alis.functions import gaussian
from alis.functions import legendre
from alis.functions import linear
from alis.functions import lineemission
from alis.functions import phionxs
from alis.functions import polynomial
from alis.functions import powerlaw
from alis.functions import random
from alis.functions import spline
from alis.functions import splineabs
from alis.functions import thar
from alis.functions import tophat
from alis.functions import variable
from alis.functions import voigt
# Convolution+shifting routines
from alis.functions import afwhm
from alis.functions import apod
from alis.functions import lsf
from alis.functions import lsffile
from alis.functions import lsfspline
from alis.functions import multivfwhm
from alis.functions import vfwhm
from alis.functions import voigtconv
from alis.functions import vsigma
from alis.functions import shift
from alis.functions import user
...
def call(prgname="",getfuncs=False,getinst=False,atomic=None,verbose=2):
    ...
    fd = dict({ 'Afwhm'          : afwhm.AFWHM,
                'apod'           : apod.APOD,
                'Ashift'         : shift.Ashift,
                'brokenpowerlaw' : brokenpowerlaw.BrokenPowerLaw,
                'chebyshev'      : chebyshev.Chebyshev,
                'constant'       : constant.Constant,
                'gaussian'       : gaussian.Gaussian,
                'gaussianconst'  : gaussian.GaussianConstant,
                'gaussianconsthelium'  : gaussian.GaussianConstantHelium,
                'legendre'       : legendre.Legendre,
                'linear'         : linear.Linear,
                'lineemission'   : lineemission.LineEmission,
                'multivfwhm'     : multivfwhm.MultiVFWHM,
                'phionxs'        : phionxs.PhotIon_CrossSection,
                'polynomial'     : polynomial.Polynomial,
                'polyshift'      : shift.polyshift,
                'powerlaw'       : powerlaw.PowerLaw,
                'random'         : random.Random,
                'spline'         : spline.Spline,
                'splineabs'      : splineabs.SplineAbs,
                'thar'           : thar.ThAr,
                'tophat'         : tophat.TopHat,
                'variable'       : variable.Variable,
                'vfwhm'          : vfwhm.vFWHM,
                'lsf'            : lsf.LSF,
                'lsffile'        : lsffile.LSFFile,
                'lsfspline'      : lsfspline.SplineLSF,
                'voigt'          : voigt.Voigt,
                'voigtconv'      : voigtconv.VoigtConv,
                'vshift'         : shift.vshift,
                'vshiftscale'    : shift.vshiftscale,
                'vsigma'         : vsigma.vSigma
                })

    # Load the user-specified functions
    msgs.info("Loading user functions")
    try:
        usr_fd, usr_atm = user.load_user_functions()
    except Exception:
