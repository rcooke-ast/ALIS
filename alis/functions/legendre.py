...
class Legendre(polynomial.Polynomial) :
    """
    ...
    def __init__(self, prgname="", getinst=False, atomic=None, verbose=2):
        ...
        self._keywd   = dict({'specid':[], 'continuum':False, 'blind':False, 'scale':[], 'min':maskval, 'max':maskval,  'blindseed':0,  'blindrange':[]})			# Additional arguments to describe the model --- 'input' cannot be used as a keyword
        self._keych   = dict({'specid':0,  'continuum':0,     'blind':0,     'scale':0, 'min':0,       'max':0, 'blindseed':0,  'blindrange':0})			# Require keywd to be changed (1 for yes, 0 for no)
        self._keyfm   = dict({'specid':"", 'continuum':"",    'blind':"",    'scale':"", 'min':"",      'max':"", 'blindseed':"",  'blindrange':""})		# Format for the keyword. "" is the Default setting
