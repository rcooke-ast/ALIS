        ...
        if self._argflag['plot']['only']:
            ...
            while not complete:
                ...
                m = alfit(self._modpass['p0'], parinfo=parinfo, functkw=fa, funcarray=self._funcarray,
                        ...
                        ncpus=self._argflag['run']['ncpus'], ngpus=self._argflag['run']['ngpus'], backend=self._argflag['run']['backend'], gputhresh=self._argflag['run']['gputhresh'], fstep=self._argflag['chisq']['fstep'],limpar=self._argflag['run']['limpar'])
                ...
                if m.status == -20:
                    ...
                    while True:
                        ...
                        mc = alfit(mpars.params, parinfo=parinfo, functkw=fa, funcarray=self._funcarray,
                                verbose=self._argflag['out']['verbose'], modpass=self._modpass, miniter=self._argflag['chisq']['miniter'], maxiter=self._argflag['chisq']['maxiter'],
                                atol=self._argflag['chisq']['atol'], ftol=self._argflag['chisq']['ftol'], gtol=self._argflag['chisq']['gtol'], xtol=self._argflag['chisq']['xtol'],
                                ncpus=self._argflag['run']['ncpus'], ngpus=self._argflag['run']['ngpus'], backend=self._argflag['run']['backend'], gputhresh=self._argflag['run']['gputhresh'], fstep=self._argflag['chisq']['fstep'],limpar=self._argflag['run']['limpar'], convtest=True)
                        # Update parameters
