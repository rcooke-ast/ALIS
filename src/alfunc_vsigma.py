...
class vSigma(alfunc_base.Base) :
    """
    Convolves the spectrum with a Gaussian with a velocity sigma vsig:
    p[0] = vsig
    """
    def __init__(self, prgname="", getinst=False, atomic=None, verbose=2):
        self._idstr   = 'vsigma'		# ID string for this class
...
#		return flub
    ...
    def getminmax(self, par, fitrng, Nsig=10.0):
        ...
        --------------------------------------------------------
        par    : The input parameters which defines the Resolution of this
                 function
    ...
    def set_vars(self, p, level, mp, ival, wvrng=[0.0,0.0], spid='None', levid=None, nexbin=None, getinfl=False, ddpid=None, getstdd=None):
        ...
        if nexbin is not None:
            ...
            elif nexbin[0] == "A" : msgs.error("bintype is set to 'A' for Angstroms, when resolution is specified as a velocity.")
            ...
            return getstdd[1]*(1.0+getstdd[0]*params[0]/299792.458), getstdd[2]*(1.0-getstdd[0]*params[0]/299792.458)
